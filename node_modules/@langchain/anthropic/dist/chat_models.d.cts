...
declare class ChatAnthropicMessages<CallOptions extends ChatAnthropicCallOptions = ChatAnthropicCallOptions> extends BaseChatModel<CallOptions, AIMessageChunk> implements AnthropicInput {
   ...
   */
  protected thinkingExplicitlySet: boolean;
  contextManagement?: AnthropicContextManagementConfigParam;
  outputConfig?: AnthropicOutputConfig;
  inferenceGeo?: string;
  ...
  protected _getInvocationParamsForTracing(options?: this["ParsedCallOptions"]): ReturnType<this["invocationParams"]>;
  protected _getCallOptionsForTracing(options: this["ParsedCallOptions"], _invocationParams: ReturnType<this["invocationParams"]>): this["ParsedCallOptions"];
  /** @ignore */
  _identifyingParams(): {
    max_tokens: number;
    model: Anthropic.Model;
    cache_control?: Anthropic.CacheControlEphemeral | null;
    container?: Anthropic.MessageCreateParamsContainer | null;
